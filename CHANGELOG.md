...
## [1.0.0] - 2026-XX-XX
### Added
- Initial release of Nigeria Law MCP
- `search_legislation` tool for full-text search across all Nigerian federal statutes
...
[Unreleased]: https://github.com/Ansvar-Systems/nigeria-law-mcp/compare/v1.0.0...HEAD
[1.0.0]: https://github.com/Ansvar-Systems/nigeria-law-mcp/releases/tag/v1.0.0
